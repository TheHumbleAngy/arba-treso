<?php
     ...
     */
?>
<input type="hidden" id="head_title" value="Statistiques - Membres">
<div class="bg-white col-10 mx-auto p-2 shadow-sm mb-2" style="border-radius: 10px">
    <div class="container-fluid">
        <div class="row mb-4 mx-auto">
            <h2 class="col-auto text-center py-2 px-5 mx-auto cadre-titre">Statistiques - Membres <span>👪</span></h2>
        </div>
        <form novalidate>
            <div class="col-12 mx-auto my-2 cadre p-4">
                ...
                <div class="row mt-2 justify-content-center">
                    <div class="col-4 col-md-3 col-lg-2">
                        <button type="button" class="btn btn-sm btn-primary col-auto px-lg-4 font-weight-bolder" onclick="displayGraph('membres')">
